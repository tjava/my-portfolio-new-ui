    ...
    return GetMaterialApp(
      ...
      builder: (context, widget) => ResponsiveWrapper.builder(
        ...
        breakpoints: [
          ...
          ResponsiveBreakpoint.autoScale(1300),
          ...
          ResponsiveBreakpoint.tag(500, name: "LARGEMOBILE"),
          ResponsiveBreakpoint.tag(600, name: TABLET),
          ResponsiveBreakpoint.tag(990, name: "SMALLDESKTOP"),
          ResponsiveBreakpoint.tag(1000, name: "SMALLDESKTOP"),
          ResponsiveBreakpoint.tag(1700, name: "LARGEDESKTOP"),
          ResponsiveBreakpoint.tag(1800, name: "XLARGEDESKTOP"),
